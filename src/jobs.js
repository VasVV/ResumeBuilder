...
export default function Jobs() {
    ...
    const jobsData = useSelector(state => state.addremovejobreducer.jobs); 
    return (
        <>
        ...
        <Container fluid>
            ...
            {jobsData.map(e => {
                return (
                    <Row>
            <Col>
                    <Row>{e.employer}, {e.jobtitle}, {e.city}, {e.country}</Row>
                    <Row> {e.startMonth} {e.startYear} - {e.endMonth},{e.endYear}</Row>
                    <Row>{e.desc}</Row>
            </Col>
            </Row>
                )
